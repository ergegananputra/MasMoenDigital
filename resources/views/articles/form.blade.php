...
<div class="blurred-background" id="form-background"></div>
    ...
    <div class="container">
        <div class="card card-form">
            ...
            <form
                ...
                <div class="section" x-data="{ open: true }">

                    <div class="divider">
                        <hr>
                        <div class="row">
                            <h4 class="col">Informasi Umum</h4>
                            <div class="col-auto btn-sm toggle" @click="open = !open">
                                <i :class="open ? 'bi bi-caret-down-fill' : 'bi bi-caret-up-fill'"></i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="section" x-data="{ open: false }">
                    ...
                    <div class="divider">
                        <hr>
                        <div class="row">
                            <h4 class="col">Informasi Pembayaran <span class="optional">(Opsional)</span> </h4>
                            <div class="col-auto btn-sm toggle" @click="open = !open">
                                <i :class="open ? 'bi bi-caret-down-fill' : 'bi bi-caret-up-fill'"></i>
                            </div>
                        </div>
                            ...
                            <div class="col-md-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="unit" id="unit" class="form-control"
                                        placeholder="Masukkan Satuan Harga"
                                        @isset($article)
                                            value="{{ $article->unit }}"
                                        @endisset
                                        >
                ...
                <div class="section" x-data="{ open: false }">
                    ...
                    <div class="divider">
                        <hr>
                        <div class="row">
                            <h4 class="col">Lokasi <span class="optional">(Opsional)</span> </h4>
                            <div class="col-auto btn-sm toggle" @click="open = !open">
                                <i :class="open ? 'bi bi-caret-down-fill' : 'bi bi-caret-up-fill'"></i>
                            </div>
                        </div>
                ...
                <div class="form-group col-md-12 item">
                    <a href="javascript:void(0);" id="tambah" onclick="addFileInput()" class="btn card-add-image col mb-4">
                        <i class="bi bi-image"></i>
                        <p>Tambah Foto Anda disini! Pastikan foto yang Anda upload tidak lebih dari 2 MB dan memiliki rasio 1:1 untuk
                            hasil yang maksimal
                        </p>
                    </a>
                    ...
                    @isset($article)
                        ...
                        <div class="alert alert-warning mt-4" role="alert"> <i class="bi bi-exclamation-circle"></i>
                            Jika Anda ingin menghapus foto yang telah diunggah sebelumnya, pastikan untuk menyimpan artikel terlebih dahulu.
                            Aksi penghapusan akan mereset form
                        </div>
                        ...
                        <div class="row row-cols-1 row-cols-md-3 g-3">
                            ...
                            @foreach ($article->images as $photo)
                                <div class="rounded-full" style="margin-bottom: 5px;" id="photo_item_{{$photo->id}}">
                                    <button class="btn btn-danger w-100" style="top: 5px; right: 5px;"
                                        onclick="deleteImage(event, {{$photo->id}})"><i class="bi bi-trash"></i> Hapus
                                    </button>
                                    <img src="{{ asset($photo->path) }}" class="rounded-full img-thumbnail mx-auto d-block gallery_item">
                                </div>
                            @endforeach
                        </div>
                    @endisset
                ...
                <div class="section" x-data="{ open: false }">
                    ...
                    <div class="divider">
                        <hr>
                        <div class="row">
                            <h4 class="col">Informasi Tambahan <span class="optional">(Opsional)</span> </h4>
                            <div class="col-auto btn-sm toggle" @click="open = !open">
                                <i :class="open ? 'bi bi-caret-down-fill' : 'bi bi-caret-up-fill'"></i>
                            </div>
                        </div>
