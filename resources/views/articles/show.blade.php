        ...
        <div class="row w-100 mb-4">
            ...
            <div class="col-md-4">
                    ...
                    <div class="card personalize-card mt-3">
                        <div class="card-body p-2">
                            <ins class="adsbygoogle"
                                ...
                                data-ad-slot="{{ config('services.adsense.slots.article-sidebar', config('services.adsense.slots.default')) }}"
                                data-ad-format="auto"
                ...
                @elseif(config('app.debug'))
                    <div class="card personalize-card mt-3" style="background: linear-gradient(135deg, #f5f7fa 0%, #e4e8ec 100%); border: 2px dashed #cbd5e1;">
                        <div class="card-body d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 250px;">
                            <div style="color: #94a3b8;">
                                ...
                                <small>Ad Slot: article-sidebar</small>
                            </div>
                        </div>
                    </div>
                @endif
